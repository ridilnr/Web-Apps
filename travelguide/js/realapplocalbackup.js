...
function loadDoc() {
    ...
    if(((sessionStorage.getItem("numComment") === null) || (sessionStorage.getItem("numComment") === "")) &&
        ...
        ((sessionStorage.getItem("numReply") === null) || (sessionStorage.getItem("numReply") === "")))
    {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState === 4 && this.status === 200) {
                ...
                /*document.getElementById("demo1").innerHTML = "comment = " + arrayNumTuple[0];
                document.getElementById("demo2").innerHTML = "Place = " + arrayNumTuple[1];
                document.getElementById("demo3").innerHTML = "Reply = " + arrayNumTuple[2];*/
                ...
                //alert("numComment : " + arrayNumTuple[0] + "\n" + "numPlace : " + arrayNumTuple[1] + "\n" + "numReply : " + arrayNumTuple[2]);
            }
        };
        xhttp.open("GET", "reloadpage.php", true);
        xhttp.send();
    }else if(sessionStorage.getItem("numComment") > 0){
...
function checkAgain(array) {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState === 4 && this.status === 200) {
            ...
            /*document.getElementById("demo1").innerHTML = "comment = " + newArrayNumTuple[0];
            document.getElementById("demo2").innerHTML = "Place = " + newArrayNumTuple[1];
            document.getElementById("demo3").innerHTML = "Reply = " + newArrayNumTuple[2];*/
            if((newArrayNumTuple[0] > sessionStorage.getItem("numComment")) ||
                (newArrayNumTuple[1] > sessionStorage.getItem("numPlace")) ||
                (newArrayNumTuple[2] > sessionStorage.getItem("numReply")))
            {
