...
/*$getUser = new User();
$getUser = $getUser ->find($_SESSION["userName"], $_SESSION["emailUser"], '%');
if($getUser){
    $userName = $getUser[0]->fname;
    $userEmail = $getUser[0]->email;
    $userPhone = $getUser[0]->phone;
    $userPassword = $getUser[0]->password;
    $script = <<< Here
    <script>
        var inputEditUname, inputEditEmail, inputEditPhone, inputEditPassword;
        linkSetting.addEventListener("click", function() {
            alert("yoooo");
        });
        inputEditUname = document.querySelector('#editUname');
        inputEditEmail = document.querySelector('#editEmail');
        inputEditPhone = document.querySelector('#editPhone');
        inputEditPassword = document.querySelector('#editPassword');
        inputEditUname.setAttribute("placeholder", '$userName');
        inputEditUname.setAttribute("value", '$userName');
        inputEditEmail.setAttribute("placeholder", '$userEmail');
        inputEditEmail.setAttribute("value", '$userEmail');
        inputEditPhone.setAttribute("placeholder", '$userPhone');
        inputEditPhone.setAttribute("value", '$userPhone');
        inputEditPassword.setAttribute("placeholder", '$userPassword');
        inputEditPassword.setAttribute("value", '$userPassword');
    </script>
Here;
    echo $script;
}*/
            ...
            <div id="divPostActivity" class="container-fluid d-flex justify-content-between">
                ...
                <section id="postSection" class="container-fluid d-flex flex-column mt-1">
                    ...
                    <div class="container-fluid scrollable">
                        <div id="postUserID1" onclick="clickPostSection(this.id)" class="row mt-1">
                        ...
                        <div id="postUserID2" onclick="clickPostSection(this.id)" class="row mt-1">
                            <div class="container-fluid d-flex justify-content-between">
                        ...
                        <div id="postUserID3" onclick="clickPostSection(this.id)" class="row mt-1">
                            <div class="container-fluid d-flex justify-content-between">
                                <div class="divMapIcon" onclick="showMapFromMapIcon();">
                                    <span class="fa fa-map-marker fa-3x"></span>
                                </div>
                        ...
                        <div id="postUserID4" onclick="clickPostSection(this.id)" class="row mt-1">
                            <div class="container-fluid d-flex justify-content-between">
                                <div class="divMapIcon" onclick="showMapFromMapIcon();">
                                    <span class="fa fa-map-marker fa-3x"></span>
                                </div>
                        ...
                        <div id="postUserID5" onclick="clickPostSection(this.id)" class="row mt-1">
                            <div class="container-fluid d-flex justify-content-between">
                                <div class="divMapIcon" onclick="showMapFromMapIcon();">
                                    <span class="fa fa-map-marker fa-3x"></span>
                                </div>
                        ...
                        <div id="containerReplyActivity" class="container-fluid">
                            ...
                            <div class="container-fluid scrollable">
                                <div class="row d-flex flex-column">
                                    ...
                                    <div id="activityUserID1" onclick="clickPostSection(this.id)" class="mt-2 ml-2 mr-2 border-solid">
                                        <div class="container-fluid d-flex justify-content-between">
                                            <div class="divMapIcon" onclick="showMapFromMapIcon();">
                                                <span class="fa fa-map-marker fa-3x"></span>
                                            </div>
                        ...
                        <div id="containerPostActivity" class="container-fluid">
                            ...
                            <div class="container-fluid scrollable">
                                <div class="row d-flex flex-column">
                                    ...
                                    <div id="activityUserID2" onclick="clickPostSection(this.id)" class="mt-2 ml-2 mr-2 border-solid">
                                        <div class="container-fluid d-flex justify-content-between">
                    ...
                    <div class="row">
                        <div class="container-fluid d-flex flex-column">
                            ...
                            <div class="divReplyForm">
                                <form action="realapp.php" class="replyForm mt-2">
                ...
                <section id="editAccountSection" class="row mt-1 w-75 hidden">
                    ...
                    <form method="post" action="phpfiles/update.php" id="editAccountForm" class="container-fluid">
                        <div class="d-flex flex-row mt-2">
                            ...
                            <div class="input-group w-75">
                                <input id="editUname" name="editUname" type="text" class="form-control" placeholder="User Name"
