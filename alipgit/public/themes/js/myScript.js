...
function getProductInfo(){
    ...
    storage.get(options, 'productToAdd', function(err, results){
        ...
        if(results !== undefined) {
            ...
            document.querySelector(".productName").innerHTML = ProductInfo.pname;
            ...
            viewImage.setAttribute("data-name", ProductInfo.pname);
            viewImage.setAttribute("data-qty", ProductInfo.qty);
            viewImage.setAttribute("data-image", viewImage.src);
        }
        else{
