...
<head>
    ...
    <![endif]-->
    <title>Phone & Tablet Cases</title>
</head>
<body>
<!-- MENU RESEARCH, LOGIN,...   -->
...
<div id="wrapper" class="container">
    ...
    <section class="header_text sub">
        <h4><span>Phone & Tablet Cases</span></h4>
    </section>
    ...
    <section class="main-content">
        ...
        <div class="row rowMainContent">
            <div id="containerFilter" class="col-md-2">
                <!--  FILTER -->
                <div class="filter">
                    <form role="form" method="post" action="{{ url('Accessories/SearchCothes') }}">
                        ...
                        <div class="row rowSizeKid">
                            <div id="rowSizeColOne" class="col-xs-12 col-sm-12 col-md-11">
                                <select id="color" class="selectMenu btn btn-default btn-block" name="size">
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="../Accessories/phone?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="../Accessories/phone?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="../Accessories/phone?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
...
<script src="../themes/js/toggleButtonKahb.js"></script>
