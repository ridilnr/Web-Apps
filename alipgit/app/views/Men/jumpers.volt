...
<head>
    ...
    <![endif]-->
    <title>Men Jumpers & Cardigans</title>
</head>
<body>
<!-- MENU RESEARCH, LOGIN,...   -->
...
<div id="wrapper" class="container">
    ...
    <section class="header_text sub">
        <h4><span>Jumpers & Cardigans</span></h4>
    </section>
    ...
    <section class="main-content">
        ...
        <div class="row rowMainContent">
            <div id="containerFilter" class="col-md-2">
                <!--  FILTER -->
                <div class="filter">
                    <form role="form" method="post" action="{{ url('Men/SearchCothes') }}">
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="../Men/jumpers?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="../Men/jumpers?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="../Men/jumpers?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
