    ...
    <section class="main-content">
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="../Men/tshirts?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="../Men/tshirts?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="../Men/tshirts?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
