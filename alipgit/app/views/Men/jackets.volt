...
<div id="wrapper" class="container">
    ...
    <section class="header_text sub">
        <h4><span>Men Jackets & Coats</span></h4>
    </section>
    ...
    <section class="main-content">
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="../Men/jackets?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="../Men/jackets?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="../Men/jackets?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
