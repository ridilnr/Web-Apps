    ...
    <section class="main-content">
        ...
        <div class="row rowMainContent">
            <div id="containerFilter" class="col-md-2">
                <!--  FILTER -->
                <div class="filter">
                    <form role="form" method="post" action="{{ url('Homeware/SearchCothes') }}">
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="../Homeware/bathroom?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="../Homeware/bathroom?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="../Homeware/bathroom?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
