...
<head>
    ...
    <![endif]-->
    <title>Women Trousers & Jumpsuits</title>
</head>
<body>
<!-- MENU RESEARCH, LOGIN,...   -->
...
<div id="wrapper" class="container">
    ...
    <section class="header_text sub">
        <h4><span>Trousers & Jumpsuits</span></h4>
    </section>
    ...
    <section class="main-content">
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="../Women/trousers?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="../Women/trousers?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="../Women/trousers?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
