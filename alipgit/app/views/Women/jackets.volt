...
<head>
    ...
    <![endif]-->
    <title>Women Jackets & Coats</title>
</head>
<body>
<!-- MENU RESEARCH, LOGIN,...   -->
    ...
    <section class="main-content">
                    ...
                    <form role="form" method="post" action="{{ url('Women/SearchCothes') }}">
                        ...
                        <div class="row rowSize">
                            <div id="rowSizeColOne" class="col-sm-6">
                                ...
                                <label class="container mycontainer"><input name="s35" value="35" type="checkbox">35<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s355" value="35.5" type="checkbox">35.5<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s36" value="36" type="checkbox">36<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s365" value="36.5" type="checkbox">36.5<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s37" value="37" type="checkbox">37<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s375" value="37.5" type="checkbox">37.5<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s38" value="38" type="checkbox">38<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s385" value="38.5" type="checkbox">38.5<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s39" value="39" type="checkbox">39<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s40" value="40" type="checkbox">40<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s405" value="40.5" type="checkbox">40.5<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s41" value="41" type="checkbox">41<span class="checkmark"></span></label>
                            </div>
                            <div id="rowSizeColTwo" class="col-sm-6">
                                ...
                                <label class="container mycontainer"><input name="s425" value="42.5" type="checkbox">42.5<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s43" value="43" type="checkbox">43<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s44" value="44" type="checkbox">44<span class="checkmark"></span></label>
                                <label class="container mycontainer"><input name="s445" value="44.5" type="checkbox">44.5<span class="checkmark"></span></label>
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="../Women/jackets?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="../Women/jackets?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="../Women/jackets?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
    ...
    function prices(){
        $(document).ready(function () {
            if(document.getElementById("Price").value != "volvo"){
                window.location.href = "../Women/set_price?price="+document.getElementById("Price").value+"&from=/jackets?page=1#";
            }
        });
    }
    function fit(){
