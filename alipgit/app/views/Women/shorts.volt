...
<head>
    ...
    <![endif]-->
    <title>Women Shorts & Skirts</title>
</head>
<body>
<!-- MENU RESEARCH, LOGIN,...   -->
    ...
    <section class="main-content">
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="../Women/shorts?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="../Women/shorts?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="../Women/shorts?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
