    ...
    <section class="main-content">
            ...
            <div class="col-md-2">
                ...
                <div id="filter">
                    <form role="form" method="post" action="{{ url('Women/SearchCothes') }}">
                        <label class="container" id="mycontainer">Color</label>
                        <div class="row">
                            <div class="col-sm-6">
                                <label class="container" id="mycontainer"><input value="Black" name="black" type="checkbox">black<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Blue" name="blue" type="checkbox">blue<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Brown" name="brown" type="checkbox">brown<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Camel" name="camel" type="checkbox">camel<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Cream" name="cream" type="checkbox">cream<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Green" name="green" type="checkbox">green<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Grey" name="grey" type="checkbox">grey<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Metallic" name="metallic" type="checkbox">metallic<span class="checkmark"></span></label>
                            </div>
                            <div class="col-sm-6">
                                <label class="container" id="mycontainer"><input value="Multi" name="multi" type="checkbox">multi<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Nude" name="nude" type="checkbox">nude<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Pink" name="pink" type="checkbox">pink<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Purple" name="purple" type="checkbox">purple<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Red" name="red" type="checkbox">red<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="White" name="white" type="checkbox">white<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input value="Yellow" name="yellow" type="checkbox">yellow<span class="checkmark"></span></label>
                            </div>
                        </div>
                        <label class="container" id="mycontainer">Size</label>
                        <div class="row">
                            <div class="col-sm-6">
                                <label class="container" id="mycontainer"><input name="s32" value="32" type="checkbox">32<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="s34" value="34" type="checkbox">34<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="s36" value="36" type="checkbox">36<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="s38" value="38" type="checkbox">38<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="s40" value="40" type="checkbox">40<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="s42" value="42" type="checkbox">42<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="s44" value="44" type="checkbox">44<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="s46" value="46" type="checkbox">46<span class="checkmark"></span></label>
                            </div>
                            <div class="col-sm-6">
                                <label class="container" id="mycontainer"><input name="XXS" value="XXS" type="checkbox">XXS<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="XS" value="XS" type="checkbox">XS<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="S" value="S" type="checkbox">S<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="M" value="M" type="checkbox">M<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="L" value="L" type="checkbox">L<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="XL" value="XL" type="checkbox">XL<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="XXL" value="XXL" type="checkbox">XXL<span class="checkmark"></span></label>
                                <label class="container" id="mycontainer"><input name="XXXL" value="XXXL" type="checkbox">XXXL<span class="checkmark"></span></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                    ...
                    function prices(){
                        $(document).ready(function () {
                            if(document.getElementById("Price").value != "volvo"){
                                window.location.href = "Women/set_price?price="+document.getElementById("Price").value+"&from=?page=1#";
                            }
                        });
                    }
                    function fit(){
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="span3">
                    <div class="product-box">
                        ...
                        <a href="ProductDetail/SetterPID/<?php echo $item->pid ?>">
                            <img id="<?php echo $item->pid ?>" class="womenProduct" onclick="getImageLink(this)" alt="" style="width: 342px; height: 250px" src="<?php echo $item->image ?>">
                        </a>
                        <br/>
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="Women?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="Women?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="Women?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
