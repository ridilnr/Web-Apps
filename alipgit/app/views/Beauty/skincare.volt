    ...
    <section class="main-content">
        ...
        <div class="row rowMainContent">
            <div id="containerFilter" class="col-md-2">
                <!--  FILTER -->
                <div class="filter">
                    <form role="form" method="post" action="{{ url('Beauty/SearchCothes') }}">
        ...
        [
            "data" => $ProductListe,
                ...
                <div class="center">
                    <ul class="pagination">
                        <li><a href="../Beauty/skincare?page=<?= $page->before; ?>"><<</a></li>
                        <li><a href="../Beauty/skincare?page=<?= $page->next; ?>"><?php echo $page->current?></a></li>
                        <li><a href="../Beauty/skincare?page=<?= $page->next; ?>">>></a></li>
                    </ul>
                </div>
            </div>
