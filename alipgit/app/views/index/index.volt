...
<head>
    ...
    <title>ALIPGIT - Shop Now Online</title>
</head>
<body>
<!-- MENU RESEARCH, LOGIN,...   -->
...
<div id="wrapper" class="container">
    <section class="navbar main-menu">
        <div class="navbar-inner main-menu">
            <a href="index" class="logo pull-left idLogo"><img src="themes/images/logo.png" class="site_logo img-responsive" alt=""></a>
    ...
    <section  class="homepage-slider" id="home-slider">
        <div class="flexslider">
            <ul class="slides">
                <li>
                    <img width="500" height="150" src="themes/images/carousel/banner-1.png" alt=""/>
                </li>
                <li>
                    <img width="500" height="200" src="themes/images/carousel/banner-2.png" alt=""/>
                    <div class="intro">
                        <!--<h1>Best online Seller in North Cyprus</h1>
                        <p><span>Up to 50% discount</span></p>
    ...
    <section class="header_text">
        We provide online shopping and delivery services for all items to your house
        <br/>Don't miss this opportunity.
    </section>
    <!-- PRODUCTS IMAGES -->
        <center>
            <div class="row container center">
                <div class="col-md-4">
                    <a href="Women?page=1"><img height="350" width="350" src="img/women.jpg"></a>
                </div>
                <div class="col-md-4">
                    <a href="Men?page=1"><img height="350" width="350" src="img/men.jpg"></a>
                </div>
                <div class="col-md-4">
                    <a href="Newest?page=1"><img height="350" width="350" src="img/new.jpg"></a>
                </div>
            </div>
        </center>
    ...
    <div class="row container center">
        <div class="col-md-4">
            <div class="support">
                ...
                <h4>MANY <strong>OPTIONS</strong></h4>
                <p class="text-justify">Our parternships with big brands offer you great opportunities of selecting products from them.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="support">
                ...
                <p class="text-justify">You do not need to make any extra payment for shipping and we deliver your items to your house.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="support">
                <img src="themes/images/feature_img_3.png" alt="" />
                <h4>48H <strong>DELIVERY</strong></h4>
                <p class="text-justify">Shop online with your correct house address and receive your products in less than 48 hours.</p>
            </div>
        </div>
    </div>
    </div>
...
<script type="text/javascript">
    //document.querySelector("._toggleMenu").style.backgroundColor = "red";
    $(function() {
