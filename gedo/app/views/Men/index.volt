...
<!--  MAIN CONTENT PAGE -->
<div id="wrapper" class="container"><section class="navbar main-menu">
    ...
    <section class="header_text sub">
        <h4><span>COSTUMES POUR HOMMES</span></h4>
    </section>
            ...
            <div class="col-md-2">
                ...
                <div id="filter">
                    <select id="colour" class="selectMenu" onchange="colors()">
                        ...
                        <?php
                        foreach(Productdetails::find("category = 'Homme'") as $p){
                                echo"<option value='$p->color'>$p->color</option>";
                        }
                        ?>
                    </select>
                    <select id="Size" class="selectMenu" onchange="sizer()" required="required">
                        <option value="volvo">Taille</option>
                        <option value="44">Toutes</option>
                    ...
                    function colors(){
                        $(document).ready(function () {
                            if(document.getElementById("colour").value != "volvo"){
                                window.location.href = "Men/set_color?color="+document.getElementById("colour").value+"&from=#";
                            }
                        });
                    }
                    function sizer(){
                        $(document).ready(function () {
                            if(document.getElementById("Size").value != "volvo"){
                                window.location.href = "Men/set_size?size="+document.getElementById("Size").value+"&from=#";
                            }
                        });
                    }
                    function prices(){
                        $(document).ready(function () {
                            if(document.getElementById("Price").value != "volvo"){
                                window.location.href = "Men/set_price?price="+document.getElementById("Price").value+"&from=#";
                            }
                        });
                    }
                    function fit(){
                        $(document).ready(function () {
                            if(document.getElementById("Fit").value != "volvo"){
                                window.location.href = "Men/set_fit?fit="+document.getElementById("Fit").value+"&from=#";
                            }
                        });
                    }
                </script>
                                ...
                                <li class="span3">
                                    <div class="product-box">
                                        ...
                                        <a href="ProductDetail">
                                            <img id="$product->pid" class="menProduct" onclick="getImageLink(this)" alt="" style="width: 342px; height: 350px" src="$product->image">
                                        </a>
                                        <br/>
                                        ...
                                        <a id="a2Get" href="ProductDetail" onclick="getImageLink(this.parentNode.firstElementChild.nextElementSibling.firstElementChild)" class="category">Pour $product->category, Tailles: 44,46,48,50,52</a>
                    ...
                    <div class="pagination pagination-small pagination-centered">
                        <ul>
                            <li>
                                ...
                                echo "<a href='Men/linker3/$down' aria-label='Previous'>
                                    <span aria-hidden='true'>&laquo;</span>
                                </a>";}
                                }else
                                echo"<a href='#' aria-label='Previous'>
                            ...
                            <?php
                                foreach ($tab as $composent)
                                    echo "<li><a href='Men/linker3/$composent'>". $composent ."</a></li>" ;
                            ?><li><?php
                                    $numb = count($tab);
                                    if(isset($deb)){
                                        if($up <= $numb){
                                            echo "<a href='Men/linker3/$up' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a>";}
                                else
                                ...
                                if(isset($tab[1]))
                                echo"<a href='Men/linker3/$tab[1]' aria-label='Next'>
                                    <span aria-hidden='true'>&raquo;</span>
                                </a>";
                                else
                                echo"<a href='#' aria-label='Next'>
