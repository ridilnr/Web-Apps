...
<div id="wrapper" class="container">
    <section class="navbar main-menu">
        <div class="navbar-inner main-menu">
            <a href="index" class="logo pull-left idLogo">
    ...
    <section class="header_text sub">
        <h4><span>LES ACCESSOIRES DE MARQUE GEDO</span></h4>
    </section>
    ...
    <section class="main-content">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <!--  FILTER -->
                <div id="filter">
                    <select id="Sub" class="selectMenu" onchange="sub_cat()">
                        <option value="volvo">Produit</option>
                        <option value="%">Tous</option>
                        <?php
                        foreach(Subcat::find("categoryname != 'Homme' AND categoryname != 'Femme'") as $p){
                        echo"<option value='$p->subcatname'>$p->subcatname</option>";
                        }
                        ?>
                    </select>
                    <select id="colour" class="selectMenu" onchange="colors()">
                        <option value="volvo">Couleur</option>
                        <option value="%">Toutes</option><?php
                        foreach(Productdetails::find("category = 'Accessoires'") as $p){
                                echo"<option value='$p->color'>$p->color</option>";
                        }
                        ?>
                    </select>
                    <select id="Size" class="selectMenu" onchange="sizer()">
                        <option value="volvo">Taille Soutien</option>
                ...
                <script type="text/javascript">
                    function sub_cat(){
                        $(document).ready(function () {
                            if(document.getElementById("Sub").value != "volvo"){
                                window.location.href = "Accessories/set_subcat?subcat="+document.getElementById("Sub").value+"&from=#";
                            }
                        });
                    }
                    function colors(){
                        $(document).ready(function () {
                            if(document.getElementById("colour").value != "volvo"){
                                window.location.href = "Accessories/set_color?color="+document.getElementById("colour").value+"&from=#";
                            }
                        });
                    }
                    function sizer(){
                        $(document).ready(function () {
                            if(document.getElementById("Size").value != "volvo"){
                                window.location.href = "Accessories/set_size?size="+document.getElementById("Size").value+"&from=#";
                            }
                        });
                    }
                    function prices(){
                        $(document).ready(function () {
                            if(document.getElementById("Price").value != "volvo"){
                                window.location.href = "Accessories/set_price?price="+document.getElementById("Price").value+"&from=#";
                            }
                        });
                    }
                </script>
                    ...
                    <ul class="thumbnails listing-products">
                        ...
                        <li class="span3">
                            <div class="product-box">
                                ...
                                <br/>
                                <a id="a1Get" href="ProductDetail" onclick="getImageLink(this.parentNode.firstElementChild.nextElementSibling.firstElementChild)" class="title">PRODUIT $product->brand</a><br/>
                                <a id="a2Get" href="ProductDetail" onclick="getImageLink(this.parentNode.firstElementChild.nextElementSibling.firstElementChild)" class="category">$product->category, Tailles: Toutes</a>
                    ...
                    <div class="pagination pagination-small pagination-centered">
                        <ul>
                            <li>
                                ...
                                echo "<a href='Accessories/linker3/$down' aria-label='Previous'>
                                    <span aria-hidden='true'>&laquo;</span>
                                </a>";}
                                }else
                                echo"<a href='#' aria-label='Previous'>
                            ...
                            <?php
                                foreach ($tab as $composent)
                                    echo "<li><a href='Accessories/linker3/$composent'>". $composent ."</a></li>" ;
                            ?><li><?php
                                    $numb = count($tab);
                                    if(isset($deb)){
                                        if($up <= $numb){
                                            echo "<a href='Accessories/linker3/$up' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a>";}
                                else
                                ...
                                if(isset($tab[1]))
                                echo"<a href='Accessories/linker3/$tab[1]' aria-label='Next'>
                                    <span aria-hidden='true'>&raquo;</span>
                                </a>";
                                else
                                echo"<a href='#' aria-label='Next'>
