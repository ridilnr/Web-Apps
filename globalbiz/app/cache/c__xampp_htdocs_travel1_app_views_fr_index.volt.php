...
<nav  class="amd-menu navbar navbar-default navbar-fixed-top theme_background_color fadeInDown">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">TRAVEL-<span class="black">1 Français</span></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="#contact" class="page-scroll" id="contacts"><i class="fa fa-send"></i>Contact us</a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <!-- contact form -->
                <form id="contact-form" method="post" action="<?= $this->url->get('Index/Apply') ?>">
    ...
    <div class="modal-dialog" id="apply">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?= $this->url->get('Index/Apply') ?>">
