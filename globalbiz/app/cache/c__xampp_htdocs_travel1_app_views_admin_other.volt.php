...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            ...
            <form class="form" method="post" action="<?= $this->url->get('Admin/CreateSubAgent') ?>">
        ...
        <div class="col-sm-3">
            ...
            <form class="form-inline" method="post" action="<?= $this->url->get('Admin/CreateCountry') ?>">
                <div class="form-group">
            ...
            <form class="form" method="post" action="<?= $this->url->get('Admin/CreateUniv') ?>">
                <div class="form-group">
